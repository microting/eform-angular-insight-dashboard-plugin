...
su ubuntu -c \
"cp -av /var/www/microting/eform-angular-insight-dashboard-plugin/out /var/www/microting/eform-angular-frontend/eFormAPI/eFormAPI.Web/out/Plugins/InsightDashboard"
