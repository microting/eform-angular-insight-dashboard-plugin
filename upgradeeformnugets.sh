...
if (( "$GIT_STATUS" > 0 )); then
  ...
  CURRENT_NUMBER_OF_COMMITS=`git log --oneline | wc -l`
	...
	PACKAGES=('Microting.eForm' 'Microting.eFormApi.BasePn' 'Microting.InsightDashboardBase')
	PROJECT_NAME='InsightDashboard.Pn.csproj'
	REPOSITORY='eform-angular-insight-dashboard-plugin'
	...
	PROJECT_NAME='InsightDashboard.Pn.Test.csproj'
	REPOSITORY='eform-angular-insight-dashboard-plugin'
