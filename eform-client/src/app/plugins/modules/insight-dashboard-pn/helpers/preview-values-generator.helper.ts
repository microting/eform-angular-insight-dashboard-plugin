...
import {
  ...
  lineSmileyDataByWeek,
  lineSmileyDataByYear,
} from '../const/chart-data/chart-data-line';
import {
  advancedPieData,
  advancedPieSmileyData,
  barChartData,
  barChartSmileyData,
  pieGridData,
  pieGridSmileyData,
...
import {
  ...
  stackedGroupedSmileyDataByWeek,
  stackedGroupedSmileyDataByYear,
...
function getChartDataByQuarter(
  chartType: DashboardChartTypesEnum,
  questionType: DashboardItemQuestionTypesEnum
) {
  switch (chartType) {
...
function getChartDataBySixMonth(
  chartType: DashboardChartTypesEnum,
  questionType: DashboardItemQuestionTypesEnum
) {
  switch (chartType) {
