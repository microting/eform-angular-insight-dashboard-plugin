// The 100% stacked banded chart renders the same MultiStacked data the
// grouped chart does, so this fixture is its twin with a different chart
// type - which is exactly the property worth pinning.
import {DashboardTestItemEditModel} from '../InsightDashboard-DashboardEdit.page';

export const dashboardStackedGroupedNormalizedItems: DashboardTestItemEditModel[] = [
  {
    firstQuestion: 'Q2',
    ...
    filterAnswer: '',
    period: 'År',
    chartType: 'Lodret Bjælke 100% Stablet Grupperet',
...
export const dashboardStackedGroupedNormalizedDataJson = {
  'id': 18,
  'dashboardName': 'Stacked Grouped Normalized',
  'surveyName': 'Test-Set',
  'surveyId': 1,
  'locationName': null,
  'locationId': null,
