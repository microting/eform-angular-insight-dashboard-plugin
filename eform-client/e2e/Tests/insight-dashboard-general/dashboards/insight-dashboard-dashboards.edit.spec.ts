...
describe('Insight Dashboard - Dashboard - Edit', function () {
  ...
  it('should fill item', function () {
    const itemToFillNum = dashboardEditPage.rowNum;
    const item = dashboardEditPage.getDashboardItem(itemToFillNum);
    // dashboardEditPage.fillItem(item);
  });
  it('should copy filled item', function () {
