...
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2a.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2a.conf.ts 
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2b.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2b.conf.ts
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2c.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2c.conf.ts
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2d.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2d.conf.ts
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2e.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2e.conf.ts
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2f.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2f.conf.ts
cp -av Documents/workspace/microting/eform-angular-insight-dashboard-plugin/eform-client/wdio-headless-plugin-step2g.conf.ts Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-headless-plugin-step2g.conf.ts
